...
public class Items {
    ...
    public static final Item SKELETON_SHEEP_SPAWN_EGG = new SpawnEggItem(Entities.SKELETON_SHEEP, 0xffffff, 15198183, new Item.Properties().group(ItemGroup.MISC))
            .setRegistryName(new ResourceLocation(MODID, "skeleton_sheep_spawn_egg"));
    public static final Item SKELETON_PIG_SPAWN_EGG = new SpawnEggItem(Entities.SKELETON_PIG, 0xffffff, 15771042, new Item.Properties().group(ItemGroup.MISC))
            .setRegistryName(new ResourceLocation(MODID, "skeleton_pig_spawn_egg"));
    public static final Item SKELETON_COW_SPAWN_EGG = new SpawnEggItem(Entities.SKELETON_COW, 0xffffff, 4470310, new Item.Properties().group(ItemGroup.MISC))
            .setRegistryName(new ResourceLocation(MODID, "skeleton_cow_spawn_egg"));
    public static final Item SKELETON_CHICKEN_SPAWN_EGG = new SpawnEggItem(Entities.SKELETON_CHICKEN, 0xffffff, 16711680, new Item.Properties().group(ItemGroup.MISC))
